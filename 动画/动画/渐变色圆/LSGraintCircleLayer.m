...
@implementation LSGraintCircleLayer
-(instancetype)initGraintCircleWithFrame:(CGRect)frame FromColor:(UIColor *)fromColor ToColor:(UIColor *)toColor LineWidth:(CGFloat)linewidth
{
    if (self = [super init]) {
        self.frame=frame;
...
+(instancetype)layerWithWithFrame:(CGRect)frame FromColor:(UIColor *)fromColor ToColor:(UIColor *)toColor LineWidth:(CGFloat)linewidth
{
    LSGraintCircleLayer * layer = [[self alloc] initGraintCircleWithFrame:frame
                                                                 FromColor:fromColor
                                                                   ToColor:toColor
                                                                 LineWidth:linewidth];
    return layer;
